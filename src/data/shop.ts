...
import { CONSUMABLE_EFFECTS, percentFromScale } from './combat'

export const CONSUMABLE_ITEMS: ConsumableItem[] = [
  {
    id: 'whiskey',
    name: '독한 뱀독 위스키',
    desc: `다음 대치에서 상대의 위협에 동요하지 않고, 내 발언의 심리 압박력이 ${Math.round((CONSUMABLE_EFFECTS.whiskeyPressure - 1) * 100)}% 증폭됩니다.`,
    price: 400,
    icon: '🥃',
    tag: '대치',
  },
  {
    id: 'smoke',
    name: '서부 연막탄',
    desc: `다음 결투 시 자욱한 연막을 피워 상대의 기본 사격 명중률을 ${Math.round(CONSUMABLE_EFFECTS.smokeAccuracy * 100)}% 감소시킵니다.`,
    price: 600,
    icon: '💨',
    tag: '결투',
  },
  {
    id: 'powder',
    name: '고급 정밀 화약',
    desc: `다음 결투 시 총알의 집탄율이 극대화되어 헤드샷 판정 범위가 ${percentFromScale(CONSUMABLE_EFFECTS.powderHeadScale)}% 넓어집니다.`,
    price: 800,
    icon: '🎯',
    tag: '결투',
  },
